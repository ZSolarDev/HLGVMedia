...
ElectronSetup.main = function() {
	...
	var windows = [{ allowHighDPI : true, alwaysOnTop : false, antialiasing : 0, background : 0, borderless : false, colorDepth : 32, depthBuffer : true, display : 0, fullscreen : false, hardware : true, height : 720, hidden : false, maximized : false, minimized : false, parameters : { }, resizable : true, stencilBuffer : true, title : "HTMLVideoLoader", vsync : false, width : 1280, x : null, y : null}];
	var _g = 0;
