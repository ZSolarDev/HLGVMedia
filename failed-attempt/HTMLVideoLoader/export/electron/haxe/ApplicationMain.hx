...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HTMLVideoLoader", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HTMLVideoLoader", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HTMLVideoLoader";
		app.meta["name"] = "HTMLVideoLoader";
		...
		#elseif air
		app.window.title = "HTMLVideoLoader";
		#else
